...
synParamStruct  syn_params, syn_inhib_params;

cell_switchesStruct cell_switchesi, cell_switches1, cell_switches2, cell_switches_sa;
...
synapse_data_type *syn_A2_A3; 
synapse_data_type *syn_A3_A4; 
synapse_data_type *syn_A4_A5; 

//synapse_data_type *syn_A1_B1; big onto small
...
float *syn_b2s1, *syn_b2s2, *syn_b2s3, *syn_b2s4;
float *syn_s2b1, *syn_s2b2, *syn_s2b3, *syn_s2b4;
