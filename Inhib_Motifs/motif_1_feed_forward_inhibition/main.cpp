...
void render() {
  ...
  if ( pause_animation == 0 ) {
      for (int i = 0; i < DTS_PER_RENDER; ++i) {   //Each pass through the loop is one render every DTS_PER_RENDER DTs
        ...
        synapseKernelLauncher_a (syn_stream[10],syn_s2b1, B_cellLayer1, A_cellLayer2, syn_B1_A2, weights_c1, SMALL, S2B, syn_switches1, RADIUS );   //S2B takes the presynaptic array size
        synapseKernelLauncher_a (syn_stream[11],syn_s2b2, B_cellLayer2, A_cellLayer3, syn_B2_A3, weights_c2, SMALL, S2B, syn_switches1, RADIUS );   //S2B takes the presynaptic array size
        synapseKernelLauncher_a (syn_stream[12],syn_s2b3, B_cellLayer3, A_cellLayer4, syn_B3_A4, weights_c3, SMALL, S2B, syn_switches1, RADIUS );   //S2B takes the presynaptic array size
        synapseKernelLauncher_a (syn_stream[13],syn_s2b4, B_cellLayer4, A_cellLayer5, syn_B4_A5, weights_c4, SMALL, S2B, syn_switches1, RADIUS );   //S2B takes the presynaptic array size
